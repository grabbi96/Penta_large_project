...
<head>
        <title>Penta Marketing Admin</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <form id="loginform" class="form-vertical" method="POST" action="{{route('admin.login')}}">
            {{ csrf_field() }}
				 <div class="control-group normal_text"> <h3><img src="{{asset('images/backend_image/logo.png')}}" alt="Logo" /></h3></div>
