...
@section('content')
    ...
    <div id="content">
        ...
        <section class="add-product-section text-center pt-5 section-padding">
            <h2>Update Commissions  asdfasdfasdfasd fasdfsfsadfasdfsadfasdfasdfasfd</h2>
                ...
                <form action="{{route('admin.commission_update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="form3">M. O</label>
                                <input type="text" id="form3" class="form-control" name="com_mo" value="{{$profit_club_commissions->pro_mo}}">
                            </div>
                        </div>
                    </div>
