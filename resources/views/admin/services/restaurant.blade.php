    ...
    <div id="content" class="myDivToPrint">
        ...
        <div class="product-content-area">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header text-center">
                            <h4 class="modal-title w-100 font-weight-bold">Add Restaurant</h4>
                        ...
                        <div class="modal-body mx-3">
                            <form action="" id="add_hospital">
                                <div class="form-group">
                                    <label data-error="wrong" data-success="right" for="defaultForm-email">Restaurant Name</label>
            ...
            <div class="text-center">
                <a href="" class="btn btn-default btn-rounded mb-4" data-toggle="modal" data-target="#modalLoginForm">Add Restaurant</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $("#add_hospital").submit(function (e) {
                ...
                jQuery.ajax({
                    url: "{{route('admin.restaurant_create')}}",
                    method: 'post',
                    data: {
                        name: value,
                        percentage:value1,
